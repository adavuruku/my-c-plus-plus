...
/*
	this keywors pointer -> is a default pointer that holds the address of the related class object
	compiler automatically add an implicit this pointer to our code to decrease compile time
	
	-> destructors -> destructors are executed immediately before an instance (obect) of a class is remove from the memory
*/
